...
PYTHONPATH=. python -m firefinds.cli.main ebay-oauth-url
PYTHONPATH=. python -m firefinds.cli.main ebay-oauth-exchange --code '<code>'
PYTHONPATH=. python -m firefinds.cli.main ebay-user-token-status
